namespace ExplorerService
{
    ...
    { 
        public TrianglePlateau(int numPlateauCorners, List<int> plateauCornersCoordinates, int[] plateauMaxCoordinates) : base(numPlateauCorners: numPlateauCorners, plateauCornersCoordinates: plateauCornersCoordinates, plateauMaxCoordinates: plateauMaxCoordinates)
        {
        }
